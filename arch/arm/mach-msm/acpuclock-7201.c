...
static struct clkctl_acpu_speed pll0_960_pll1_737_pll2_1593_pll4_800_25a[] = {
	...
	{ 1, 398400, ACPU_PLL_2, 2, 3, 49800, 3, 4, 150000 },
	{ 0, 400000, ACPU_PLL_4, 6, 1, 50000, 3, 4, 122880 },
	{ 1, 480000, ACPU_PLL_0, 4, 1, 60000, 3, 5, 122880 },
	{ 1, 796800, ACPU_PLL_2, 2, 1, 99600, 3, 7, 200000 },
...
static void __init acpu_freq_tbl_fixup(void)
{
	...
	if (cpu_is_msm7x25a()) {
		if (pll1_l == PLL_737_MHZ) {
			acpu_freq_tbl =	pll0_960_pll1_737_pll2_1593_pll4_800_25a;
		}
	} else {
	...
	axi_200mhz = (pll2_l == PLL_1593_MHZ || pll2_l == PLL_800_MHZ);
